...
ALTER TABLE "station_facilities" ADD COLUMN "platform_location_cell_id" uuid NOT NULL;--> statement-breakpoint
...
ALTER TABLE "station_facilities" ADD CONSTRAINT "station_facilities_platform_location_cell_id_platform_location_cells_id_fk" FOREIGN KEY ("platform_location_cell_id") REFERENCES "public"."platform_location_cells"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "platform_locations" DROP COLUMN "near_platform_cell";--> statement-breakpoint
